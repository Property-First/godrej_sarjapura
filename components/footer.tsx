...
export function Footer() {
  ...
  <span className="text-sm text-background/70 ml-2">Bannerghatta</span>
</div>

<p className="text-background/60 text-sm leading-relaxed">
  Premium 2, 3 & 4.5 BHK residences in South Bangalore with ultra low-density living. Starting ₹1.54 Cr+
</p>
          </div>
